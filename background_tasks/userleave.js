...
module.exports = {
    ...
    execute(client) {
        client.on("guildMemberRemove", (guildMember) => {
            ...
            const funnyReplies = [
                "Au revouirar! Or something along those lines.",
                "Goodbye!",
                "BYE!!",
            ...
            const embed = new MessageEmbed()
                .setDescription(`<@!${guildMember.id}> left ${guildMember.guild.name}. ${funnyReplies[Math.floor(Math.random() * funnyReplies.length)]}`)
