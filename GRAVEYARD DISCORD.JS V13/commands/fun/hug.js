...
module.exports = {
    ...
    async execute(interaction) {
        ...
        await interaction.reply({ embeds: [await makeEmbed(interaction.client, `${interaction.user.username} hugs ${ await interaction.options.getUser("target").username}!`, null, info, hugGifs[hugGif])] });
    },
};
